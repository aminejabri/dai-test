...
DROP TABLE IF EXISTS `COMPOSER_PER_UTIL`;
...
-- LISTAGE DE LA STRUCTURE DE LA TABLE MLR1. COMPOSER_PER_UTIL
DROP TABLE IF EXISTS `COMPOSER_PER_UTIL`;
CREATE TABLE IF NOT EXISTS `COMPOSER_PER_UTIL` (
  `CPU_ID` INT(10) NOT NULL AUTO_INCREMENT,
  `CPU_PROG_ID` INT(10) NOT NULL,
  `CPU_UTIL_ID` INT(10) NOT NULL,
  `CPU_PER_ID` INT(10) NOT NULL,
  `CPU_ORDRE_PER` INT(10) NOT NULL,
  PRIMARY KEY (`CPU_ID`),
  UNIQUE KEY `UNI_CPU_PROG_ID` (`CPU_PROG_ID`,`CPU_UTIL_ID`,`CPU_PER_ID`,`CPU_ORDRE_PER`),
  KEY `I_FK_COMPOSER_PER_UTIL_PROGRAMME` (`CPU_PROG_ID`),
  KEY `I_FK_COMPOSER_PER_UTIL_UTILISATEUR` (`CPU_UTIL_ID`),
  KEY `I_FK_COMPOSER_PER_UTIL_PERIODE` (`CPU_PER_ID`),
  CONSTRAINT `FK_COMPOSER_PER_UTIL_PERIODE` FOREIGN KEY (`CPU_PER_ID`) REFERENCES `PERIODE` (`PER_ID`),
  CONSTRAINT `FK_COMPOSER_PER_UTIL_PROGRAMME` FOREIGN KEY (`CPU_PROG_ID`) REFERENCES `PROGRAMME` (`PROG_ID`),
  CONSTRAINT `FK_COMPOSER_PER_UTIL_UTILISATEUR` FOREIGN KEY (`CPU_UTIL_ID`) REFERENCES `UTILISATEUR` (`UTIL_ID`)
) ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE IF NOT EXISTS `COMPOSER_PER_PRO` (
  ...
  PRIMARY KEY (`CPP_ID`),
  UNIQUE KEY `UNI_CPP_PROG_ID` (`CPP_PROG_ID`,`CPP_PER_ID`,`CPP_ORDRE_PER`),
